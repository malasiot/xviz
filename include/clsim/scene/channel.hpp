#ifndef CLSIM_SCENE_CHANNEL_HPP
#define CLSIM_SCENE_CHANNEL_HPP

#include <clsim/scene/timeline.hpp>
#include <clsim/scene/easing.hpp>
#include <clsim/scene/keyframe_sampler.hpp>
