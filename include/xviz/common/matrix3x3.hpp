...
inline const Matrix3x3 &Matrix3x3::operator += (const Matrix3x3 &m2) {
...
inline const Matrix3x3 &Matrix3x3::operator *= (float s) {
...
const Matrix3x3 &Matrix3x3::operator *= (const Matrix3x3 &m2)
{
    double s1, s2, s3 ;
    Matrix3x3 t ;
...
Matrix3x3 Matrix3x3::inverse(bool *invertible) const
{
    Matrix3x3 inv ;
