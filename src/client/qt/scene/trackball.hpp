#ifndef XVIZ_QT_SCENE_TRACKBALL_HPP
#define XVIZ_QT_SCENE_TRACKBALL_HPP
...
public:
    ...
    void setCamera(xviz::CameraPtr c, const Eigen::Vector3f &eye, const Eigen::Vector3f &center, const Eigen::Vector3f &up);
