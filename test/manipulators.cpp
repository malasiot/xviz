...
int main(int argc, char **argv)
{
    ...
    TranslatePlaneManipulator *tp = new TranslatePlaneManipulator(box_node, 0.5, Vector3f{0, 1, 0}) ;
    tp->setOrder(3) ;
    ...
    ManipulatorPtr tpm(tp) ;

    box_node->addChild(rm) ;
    box_node->addChild(tm) ;
    box_node->addChild(tpm) ;
